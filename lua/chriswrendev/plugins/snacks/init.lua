return {
    ...
    opts = {
        ...
        styles = require("chriswrendev.plugins.snacks.styles"),
        indent = require("chriswrendev.plugins.snacks.indent"),
        picker = require("chriswrendev.plugins.snacks.picker"),
        dashboard = require("chriswrendev.plugins.snacks.dashboard"),
    },
}
